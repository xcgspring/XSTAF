...
class Ui_DUTWindow(object):
    def setupUi(self, DUTWindow):
        ...
        self.actionStartRunner.setIcon(icon4)
        self.actionStartRunner.setObjectName(_fromUtf8("actionStartRunner"))
        self.actionRefresh = QtGui.QAction(DUTWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/refresh.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRefresh.setIcon(icon5)
        self.actionRefresh.setObjectName(_fromUtf8("actionRefresh"))
        self.actionPauseRunner = QtGui.QAction(DUTWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/pause.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPauseRunner.setIcon(icon6)
